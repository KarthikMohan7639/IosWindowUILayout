...
function tagColor(tag) {
  const map = {
    NDA: "bg-cyan-500/20 text-cyan-300",
    Legal: "bg-cyan-500/20 text-cyan-300",
    Invoice: "bg-purple-500/20 text-purple-300",
    Stripe: "bg-purple-500/20 text-purple-300",
    Finance: "bg-cyan-500/20 text-cyan-300",
    Q4: "bg-white/[0.06] text-white/50",
    Brief: "bg-white/[0.06] text-white/50",
    Project: "bg-white/[0.06] text-white/50",
    Design: "bg-white/[0.06] text-white/50",
    Notes: "bg-white/[0.06] text-white/50",
    Meeting: "bg-white/[0.06] text-white/50",
    Photo: "bg-cyan-500/20 text-cyan-300",
    Resume: "bg-orange-500/20 text-orange-300",
    Installer: "bg-white/[0.06] text-white/50",
  };
  return map[tag] || "bg-white/[0.06] text-white/50";
}
...
export default function FileList({
  ...
  return (
    <div className="flex flex-col h-full">
      {/* ── toolbar / breadcrumbs (hidden at root) ─────────── */}
      ...
      >
        {/* ── column headers ────────────────────────────────── */}
        <div className="grid grid-cols-[1fr_140px_100px_80px] gap-2 px-4 py-2 border-b border-white/[0.06] text-[11px] uppercase tracking-wider text-white/30 select-none">
          <span>Name</span>
          <span>AI Tags</span>
          <span>Modified</span>
        ...
        {sorted.map((item, i) => {
          ...
          return (
            <motion.div
              ...
              className={cn(
                "grid grid-cols-[1fr_140px_100px_80px] gap-2 items-center",
